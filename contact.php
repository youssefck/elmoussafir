        ...
        <div id="contact" class="contact-area section-padding">
            <div class="container">                                    
                <div class="row">
                    <div class="col-lg-7">    
                        <div class="contact">
                            <form id="contactForm" class="form" name="enq">
                                <input type="hidden" name="access_key" value="a683379a-0273-4b66-98f8-e590111bf0bc">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12">
                                        <textarea rows="6" name="message" class="form-control" placeholder="Votre Message" required></textarea>
                                    </div>
                                    <div class="col-md-12 text-center">
                                        <button type="submit" class="btn btn-contact-bg" title="Envoyer le Message!">Envoyer le Message</button>
                                    </div>
                                </div>
                            </form>
                        </div>
